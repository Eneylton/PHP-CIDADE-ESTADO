...
$qtd = Estado:: getQtd($where);

$pagination = new Pagination($qtd, $_GET['pagina'] ?? 1, 7);

$listar = Estado::getList($where, 'id desc',$pagination->getLimit());
...
include __DIR__ . '../../../includes/estado/estado-form-list.php';
