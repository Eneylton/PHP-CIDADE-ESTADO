      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item menu-close">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item">
              <a href="pages/clientes/clinte-list.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Cidades</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="pages/estados/estado-list.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Estados</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="pages/cidades/cidade-list.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Cidades</p>
              </a>
            </li>
